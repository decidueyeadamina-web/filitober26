...
## BATHROOM SCENE
    ...
    # first point and click interaction (see bathroomscript.rpy to edit)
...
## WAKE SCENE
    ...
    #starts the wake bg point and click (see wakescript.rpy to edit)
